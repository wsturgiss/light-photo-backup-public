...
class PolicyTest {
 ...
 @Test fun immichUrlAddsHttpsAndRemovesTrailingSlash(){assertEquals("https://photos.example.com",ImmichRepository.normalizeUrl(" photos.example.com/ "));assertEquals("https://photos.example.com",ImmichRepository.normalizeUrl(" https://photos.example.com/ "));assertThrows(IllegalArgumentException::class.java){ImmichRepository.normalizeUrl("http://photos.example.com")}}
